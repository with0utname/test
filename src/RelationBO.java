...
public class RelationBO {
    ...
    public static List<RelationBO> getRelationBOList() {
        return relationBOList;
    }

    public static void setRelationBOList(List<RelationBO> relationBOList) {
        RelationBO.relationBOList = relationBOList;
    }
